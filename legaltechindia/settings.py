"""
Django settings for legaltechindia project.
...
ALLOWED_HOSTS = ['legaltechindia.in', 'www.legaltechindia.in','127.0.0.1']
...
WSGI_APPLICATION = 'legaltechindia.wsgi.application'
